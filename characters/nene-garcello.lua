...
function onCreate()
    ...
    if getModSetting('neneComboAnim', currentModDirectory) == nil then
        neneComboAnim = 'Disabled'
    else
        neneComboAnim = getModSetting('neneComboAnim', currentModDirectory)
    end
end
...
--[[
    ...
    Go check the 'abot-speaker-garcello' script for more information at line 385.
]]
function onCreatePost()
    addLuaScript('characters/abot-speaker-garcello')
    callScript('characters/abot-speaker-garcello', 'createSpeaker', {'nene-garcello', 0, 0}) -- {characterName, offsetX, offsetY}
end

local comboAnimActive = true
function goodNoteHit(membersIndex, noteData, noteType, isSustainNote)
    if comboAnimActive == true then
