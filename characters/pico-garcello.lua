function onCreate()
    if boyfriendName == 'pico-garcello' then
...
function onDestroy()
    ...
    if boyfriendName == 'pico-garcello' and stringEndsWith(getPropertyFromClass('backend.ClientPrefs', 'data.pauseMusic'), ' (Pico)') then
...
function onUpdate(elapsed)
    if boyfriendName == 'pico-garcello' and inGameOver == true then
...
function onGameOverConfirm(isNotGoingToMenu)
    if isNotGoingToMenu == true and boyfriendName == 'pico-garcello' then
